...
This module provides a unified ONNX-based embedding model that replaces
sentence-transformers throughout the codebase, eliminating PyTorch dependencies.
"""
...
class ONNXEmbeddingModel:
    ...
    def __init__(self, model_path: str = None, thread_limit: int = 4):
        ...
        with error_context("ONNXEmbeddingModel", "initialization", error_code=ErrorCode.TOOL_INITIALIZATION_ERROR):
            ...
            if not self.model_path.exists():
                raise ToolError(
                    f"ONNX model not found at {model_path}. Run scripts/setup_onnx.py to set up the model.",
    ...
    def encode(self, texts: Union[str, List[str]], batch_size: int = 32, 
        ...
        """
        with error_context("ONNXEmbeddingModel", "encoding", error_code=ErrorCode.MEMORY_EMBEDDING_ERROR):
            ...
            for i in range(0, len(texts), batch_size):
                ...
                for name in self.input_names:
                    if name in encoded:
                        ...
                        # all-MiniLM-L6-v2 expects token_type_ids
                ...
                # Apply mean pooling for token-level outputs

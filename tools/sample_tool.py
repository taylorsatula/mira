"""
Example tool implementation for the AI agent system.
 
This module demonstrates how to create a tool that follows the tool interface
contract, including input/output handling patterns and tool-specific state management.
"""
import logging
import random
